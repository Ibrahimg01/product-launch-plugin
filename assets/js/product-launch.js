...
class EnhancedProductLaunchCoach {
    ...
    formatAnalysisContent(content) {
        ...
        let formatted = content
            ...
            .replace(/^(\d+)\.\s+(.+?)$/gm, '<div class="analysis-list-item" style="margin: 16px 0; padding-left: 12px; line-height: 1.6;"><span class="list-number" style="font-weight: 700; color: #3b82f6; margin-right: 8px;">$1.</span><span style="color: #374151;">$2</span></div>')
