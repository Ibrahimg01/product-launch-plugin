    ...
    public function enqueue_admin_assets($hook) {
        ...
        wp_localize_script('pl-validation-admin', 'plValidation', array(
            ...
            'networkStrings' => array(
                ...
                'viewReport' => __('View Report', 'product-launch'),
                'closeReport' => __('Close report', 'product-launch'),
                'reportTitle' => __('Idea report', 'product-launch'),
                'reportSummary' => __('Summary', 'product-launch'),
                'reportScoreBreakdown' => __('Score breakdown', 'product-launch'),
                'reportConfidence' => __('Confidence', 'product-launch'),
                'reportInsights' => __('Insights', 'product-launch'),
                'reportMarket' => __('Market validation', 'product-launch'),
                'reportAudience' => __('Target audience', 'product-launch'),
                'reportPainPoints' => __('Customer pain points', 'product-launch'),
                'reportOpportunities' => __('Validation opportunities', 'product-launch'),
                'reportActionPlan' => __('Action plan', 'product-launch'),
                'reportTags' => __('Tags', 'product-launch'),
                'reportGenerated' => __('Generated', 'product-launch'),
                'reportEmpty' => __('No additional insights were provided for this idea.', 'product-launch'),
                'reportError' => __('Unable to open the idea report. Please try again.', 'product-launch'),
                'untitledIdea' => __('Untitled Idea', 'product-launch'),
